...
-- Adicionando as chaves estrangeiras usando ALTER TABLE

ALTER TABLE especialidades
  ADD CONSTRAINT fk_servico_id
  FOREIGN KEY (servico_id)
  REFERENCES servicos (id);

ALTER TABLE prestadores
  ADD CONSTRAINT fk_especialidade_id
...
ALTER TABLE contratos
  ADD CONSTRAINT fk_contratos_prestadores1
...
ALTER TABLE contratos
  ADD CONSTRAINT fk_contratos_status1
...
ALTER TABLE enderecos_cliente
  ADD CONSTRAINT fk_enderecos_cliente_clientes1
  FOREIGN KEY (cliente_id)
  REFERENCES clientes (id)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
...
ALTER TABLE telefones_cliente
  ADD CONSTRAINT fk_telefone_clientes1
  FOREIGN KEY (cliente_id)
  REFERENCES clientes (id)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
